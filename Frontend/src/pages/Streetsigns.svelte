<script>
  ...
  function predict(data) {
      let url =
          "https://api-inference.huggingface.co/models/Azeglio/Streetsigns";
      axios
          .post(
              url,
              data, //image data
          ...
          .catch(function (error) {
              // error 503 Object { error: "Model Azeglio/streetsigns_classficiation is currently loading", estimated_time: 20 }1
